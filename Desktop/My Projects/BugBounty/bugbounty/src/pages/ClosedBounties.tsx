...
const ClosedBounties = () => {
    ...
    const mockClosedData = [
        { id: 1, subject: "Web3js - Error when calling function", bounty: 0.45, open: false, postdate: "8/12/2022" },
        { id: 2, subject: "Solidity - Error when connecting new Contract to Proxy Contract", bounty: 1.50, open: false, postdate: "8/10/2022"},
        { id: 3, subject: "Ethers.js - Help formatting BigNumber to jsx", bounty: 0.12, open: false, postdate: "7/29/2022"},
    ];

  return (
    <div className='flex flex-col text-white text-center'>
        <div className='flex flex-row justify-center items-center pr-3 bg-[#3c3939] py-1 pb-2 shadow-md'>
            <header className='flex-1 ml-[10rem] font-bold text-red-500'>Closed Bounties</header>
